...
so later E2E runs never overwrite versioned PNGs). All were regenerated after the step indicator change.
The new ones are `19-alias-homologacion-invalido`, `20-nombre-del-certificado-no-coincide` and
`21-guia-homologacion-dn-existente`.
