...
- No full E2E, browser visual verification or production validation. There are no UI, interaction-layout, theme or accessibility changes. Apply the migration before serving the updated frontend; old wildcard part reads will fail closed after column revocation.
