-- ============================================================================
-- M7 7E.3 - Corrige el predicado del check bfe_income_duplicated.
--
-- NO TOCA NI UN SOLO DATO. Solo reemplaza finance_health_check_v2 con el mismo
-- cuerpo de 7C y UN bloque cambiado: el del check de ingreso duplicado.
--
-- Detectado tras desplegar M7 en produccion: el check marcaba critical sobre
-- dos comprobantes cuyos asientos eran correctos. Eran cobros MIXTOS. El
-- diagnostico completo, y por que se compara contra los pagos y no contra
-- total_bruto, esta escrito junto al bloque mas abajo.
--
-- El resto de la funcion se reproduce sin cambios desde
-- 20260713280000_m7_7c_health_check_v2.sql.
-- ============================================================================
