...
const r2b = '20260923121000_sec08e_r2b_client_contract_gate_minimum_1.sql'
...
CREATE FUNCTION`)
  ...
  for (let attempt = 0; attempt < 40; attempt++) {
    ...
    if (attempt === 39) throw Error('slow admitted request was not observed')
    await pause(50)
  }
  sql('SET ROLE postgres;\n' + readFileSync(`supabase/migrations/${r2b}`, 'utf8'))
  ...
  console.log(`RESULT ${passed}/${passed} SEC-08E R2 real PostgreSQL/PostgREST scenarios passed`)
