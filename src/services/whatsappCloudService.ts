...
// NOTA DE SEGURIDAD: se eliminó `saveManualConnection`. Cargar el access_token
// de Meta desde el frontend exponía el secreto en el cliente. La conexión Cloud
// API debe establecerse server-side (Embedded Signup vía edge function), donde
// el token nunca pasa por el navegador. Hasta que ese flujo esté disponible,
// los negocios usan el fallback manual (wa.me / WhatsApp Web / Desktop).
