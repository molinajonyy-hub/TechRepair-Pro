...
// Mercado Pago logo: official full-color logo on white background
const MercadoPagoLogo = ({ size = 40 }: { size?: number }) => (
  <div style={{
    background: 'white',
    borderRadius: '10px',
    padding: '5px',
    ...
    <svg width={size} height={size} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      {/* Oval container */}
      <ellipse cx="100" cy="74" rx="92" ry="66" fill="none" stroke="#1a0dab" strokeWidth="6"/>
      <clipPath id="mpOvalClip">
        <ellipse cx="100" cy="74" rx="89" ry="63"/>
      </clipPath>
      {/* Argentine flag stripes inside oval */}
      <rect x="11" y="11" width="178" height="126" fill="#3eb5f5" clipPath="url(#mpOvalClip)"/>
      <rect x="11" y="28" width="178" height="42" fill="white" clipPath="url(#mpOvalClip)"/>
      <rect x="11" y="70" width="178" height="42" fill="#3eb5f5" clipPath="url(#mpOvalClip)"/>
      <rect x="11" y="112" width="178" height="25" fill="white" clipPath="url(#mpOvalClip)"/>
      {/* Handshake silhouette */}
      <g clipPath="url(#mpOvalClip)">
        {/* Left arm/hand */}
        <path d="M30 72 C40 58 58 54 72 58 C80 60 86 65 92 68 L88 76 C82 73 76 68 68 67 C56 65 42 70 36 82 Z" fill="#1a0dab"/>
        {/* Right arm/hand */}
        <path d="M170 72 C160 58 142 54 128 58 C120 60 114 65 108 68 L112 76 C118 73 124 68 132 67 C144 65 158 70 164 82 Z" fill="#1a0dab"/>
        {/* Joined hands center */}
        <path d="M88 68 C92 60 100 56 108 68 C112 74 110 82 100 84 C90 82 88 76 88 68 Z" fill="#1a0dab"/>
        {/* Knuckle bumps on left */}
        <circle cx="78" cy="72" r="7" fill="#1a0dab"/>
        <circle cx="88" cy="67" r="7" fill="#1a0dab"/>
        {/* Knuckle bumps on right */}
        <circle cx="122" cy="72" r="7" fill="#1a0dab"/>
        <circle cx="112" cy="67" r="7" fill="#1a0dab"/>
      </g>
      {/* "mercado" text */}
      <text x="100" y="154" textAnchor="middle"
        fontFamily="'Helvetica Neue', Arial, sans-serif"
        fontSize="30" fontWeight="900" fill="#1a0dab" letterSpacing="-0.5">mercado</text>
      {/* "pago" text */}
      <text x="100" y="186" textAnchor="middle"
        fontFamily="'Helvetica Neue', Arial, sans-serif"
        fontSize="30" fontWeight="900" fill="#1a0dab" letterSpacing="-0.5">pago</text>
    </svg>
  </div>
)
